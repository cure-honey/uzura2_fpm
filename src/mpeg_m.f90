    module mpg_m
        ...
        type :: mpg_t
            ...
            integer :: layer           =  2 ! layer { 1 = III, 2 = II, 3 = I }
            integer :: ibit_rate       = 12 ! 192 * 2 = 384kbps 
            integer :: isample_rate    =  0 ! 0:44.1kHz 1:48kHz 2:32kHz 3:reserved
        ...
        integer, parameter :: mpeg_bit_rates(0:14, 3) = &
                 reshape( [ 0, 32, 40, 48,  56,  64,  80,  96, 112, 128, 160, 192, 224, 256, 320,   &
                            ...
                            0, 32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384, 414, 448 ], [15, 3] )
        ...
        character (len = *), parameter :: mpeg_psy_names(0:*)     = [character(len = 7)::'enoken2', '', '', '']
